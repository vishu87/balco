...
$objPHPExcel->getActiveSheet()->getColumnDimension('O')->setWidth(20);
	...
	//$offset= -1;
		...
		if($row_pay["dos"])
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$seq, date("d/m/y", $row_pay["dos"]));
		
		if($row_pay["doe"])
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q'.$seq, date("d/m/y", $row_pay["doe"]));
