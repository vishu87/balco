	  ...
	  document.getElementById('dt2_'+dt).style.backgroundColor='#5F6888';
						...
						<?php
							...
							else
							{
								...
								$sql_groups="SELECT * from coach_groups WHERE (city_name='$city' AND center_name='$center') AND coach_id='$row_mem[id]' ";
							}
						...
						<?php
$sql_case="SELECT * from students WHERE ( train_city='$city' AND center='$center') AND (groupid='$group' AND active='0') ";
...
?>
						...
						<form action="attendance/process_attendance.php?type=1&amp;month=<?php echo $month;?>&amp;year=<?php echo $year;?>&amp;center=<?php echo $center;?>&amp;city=<?php echo $city;?>&amp;group=<?php echo $group;?>" method="post" onsubmit="return validate_form(this)" enctype="multipart/form-data">
						<table cellspacing="0" cellpadding="0" width="100%" style="margin-top:10px;">
							<?php
							$sql_dummy="SELECT * from attendance WHERE (student_id='dm' AND city_name='$city') AND (center_name='$center' AND group_name='$group') AND (month='$month' AND year='$year') ";
