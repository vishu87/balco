...
?>
						...
						<?php
								...
								$sql_groups="SELECT DISTINCT coach_name from coach_groups WHERE city_name='$city' AND center_name='$center' ";
							...
							while($row_groups = mysql_fetch_array($result_groups))
							{
								...
								if(	$row_groups["coach_name"] == $coach)
								{
									...
									border-right:2px solid #bbb;"><a href="?month='.$_GET["month"].'&amp;year='.$_GET["year"].'&amp;city='.$_GET["train_city"].'&amp;train_center='.$_GET["train_center"].'&amp;coach='.$row_groups["coach_name"].'">'.$row_groups["coach_name"].'</a></span>&nbsp;&nbsp;&nbsp;';
								}
								else
								{
									echo '&nbsp;&nbsp;&nbsp;<span style="padding:3px; background:#bbb; color:#fff; border:2px solid #bbb;"><a href="?month='.$_GET["month"].'&amp;year='.$_GET["year"].'&amp;city='.$_GET["train_city"].'&amp;train_center='.$_GET["train_center"].'&amp;coach='.$row_groups["coach_name"].'">'.$row_groups["coach_name"].'</a></span>&nbsp;&nbsp;&nbsp;';
